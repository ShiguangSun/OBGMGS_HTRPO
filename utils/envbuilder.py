...
from .wrapper import ActionNormalizer
import gym
...
robotsuite_envs = {"BaxterLift", "BaxterPegInHole", "SawyerLift", "SawyerNutAssembly", "SawyerNutAssemblyRound",
                   ...
                   "SawyerStack"}
softgym_envs = {"ClothFold", "ClothPick", "ClothDrop", "ClothFoldDrop", "RopeFold", "RopePick"}
...
def get_env_type(args):
    ...
    elif env_id in softgym_envs:
        return "softgym", env_id
